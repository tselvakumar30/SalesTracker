    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        if !(indexPath.section == 0 && indexPath.section == 1)
        {
            ...
            if dDestinationLatitude == 0.0{
                let dDestinationLatitude1:Double = Double(((arrayShopList[(indexPath as NSIndexPath).section-2] as AnyObject).value(forKey: "latitude2") as? String)!)!
                let dDestinationLongitude1:Double = Double(((arrayShopList[(indexPath as NSIndexPath).section-2] as AnyObject).value(forKey: "longitude2") as? String)!)!

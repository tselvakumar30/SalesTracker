import UIKit
class imageFiles: UIImage {
    let imagePastAssignment = UIImage(named: "pastassignment")
    let imageAddShop = UIImage(named: "addshops")
    let imageLogout = UIImage(named: "logout")
    let imageShopAssigned = UIImage(named: "shopassignment")
